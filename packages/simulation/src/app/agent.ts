...
export const agentConfigs: AgentConfigs = {
  lemo: {
    name: 'Lemo',
    goal:
      // 'Establish and grow a successful lemonade business by creating high-quality, refreshing lemonade products. For that you need to find a way to get lemons to make your lemonade, and a business permit to run your business, and of course to promote it, you would need a poster.',
      'Establish and grow a successful lemonade business by creating high-quality, refreshing lemonade products. For that you need to find a way to get lemons to make your lemonade. You are a cheapskate so you want to bargain as much as possible with other agents that you are requesting a service from',
    description:
  ...
  //   name: 'Pixie',
  //   goal:
  //     'Create professional digital posters for other agents to promote their businesses and events effectively',
  //   description:
  ...
  //   providerCatalog: [
  //     { product: 'Poster', price: 10 },
  //   ],
  // },
  // lexie: {
  //   name: 'Lexie',
  //   goal:
  //     'Guide agents through the business permit and licensing process to ensure legal compliance and smooth business operations',
  //   description:
